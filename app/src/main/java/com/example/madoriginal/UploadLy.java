...
public class UploadLy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_ly);

        actionBar=getSupportActionBar();
        actionBar.setTitle("Add Lyrics");
        ...
        storageReference= FirebaseStorage.getInstance().getReference().child("LyricsImage");
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
               ...
               storageReference.child(key+".jpg").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                   ...
                   public void onSuccess(Uri uri) {
                       ...
                       hashMap.put("LyricsName",imageName);
                       ...
                       Dataref.child(key).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                           ...
                           public void onSuccess(Void unused) {
                               Toast.makeText(UploadLy.this,"Data Successfully Uploaded",Toast.LENGTH_SHORT).show();
                               startActivity(new Intent(getApplicationContext(),LyricsContributer.class));
