...
import com.example.madoriginal.UploadGcordes;
...
public class GcodeContributer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(GcodeContributer.this, UploadGcordes.class));
            }
        });
        ...
        Delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(GcodeContributer.this, GcodeDisplay.class));
            }
        });
